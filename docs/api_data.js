define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": " http://localhost/api/payment/client-info/:account/:codeOrg"
      }
    ],
    "error": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": " http://localhost/api/payment/transaction"
      }
    ],
    "error": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": " http://localhost/api/payment/organization"
      }
    ],
    "error": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": " http://localhost/api/payment/transaction/status"
      }
    ],
    "error": {
      "fields": {
